...
from keras.layers import SeparableConv2D, Convolution2D, Activation #Allow for custom activation functions + Sep2D if desired
...
class CNNPlayer(AlgorithmBase):
    ...
    *** This network ONLY sees the screen to learn/predict at all times, no memory or variable data ***
    ...
    # ____________________ THIS NEEDS TO BE CHANGED FOR THE CNN ____________________ #
    def build_actor(self):
        """
        This method needs to be changed to use a CNN instead of NN.
    ...
    # ____________________ THIS (probably) NEEDS TO BE CHANGED FOR THE CNN ____________________ #
    def run(self):
